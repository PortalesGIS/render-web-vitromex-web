  ...
  if (path.length > 4) {
    return (
      <div className="h-full items-center grid grid-cols-3">
        <div></div>
        <div className="small:text-[22px] xsmall:text-[20px] large:text-[28px]  font-bold uppercase text-shadow justify-self-center">
          <h1>{state}</h1>
        </div>
    ...
    return (
      <div className="h-full flex justify-center items-center text-neutral80">
        <h1 className="small:text-[22px] xsmall:text-[20px] large:text-[28px] font-bold uppercase text-shadow">{state}</h1>
      </div>
    );
  }
};
